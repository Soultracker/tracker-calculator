...
class GrainList extends Component {
  ...
  handleSubmit(event) {
    ...
    const bpmRes = this.msecToBpm(this.state.sampleLength, this.state.numberOfBeat);
    const noteDurationRes = this.noteDuration(this.state.sampleLength, this.state.numberOfBeat, this.state.notePerBeat);
        ...
        <form onSubmit={this.handleSubmit.bind(this)}>
          <div className="field">
            ...
            <div className="control">
              <input type="number" id="sampleLength" name="sampleLength" value={this.state.sampleLength} onChange={this.handleChange.bind(this)} />
            </div>
  ...
  msecToBpm(sampleLength, numberOfBeat) {
    return 60000 / sampleLength * numberOfBeat;
  }

  noteDuration(sampleLength, numberOfBeat, notePerBeat) {
    return sampleLength / (numberOfBeat * notePerBeat);
  }
